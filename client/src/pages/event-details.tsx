...
export default function EventDetailsPage() {
  ...
  const { mutateAsync: createRegistration, isPending } =
    useCreateRegistration();
      ...
      <div className="bg-white rounded-3xl overflow-hidden shadow-xl border border-border/50">
        <div className="relative h-64 md:h-96">
          ...
          <div className="absolute bottom-0 left-0 p-8 text-white">
            <div className="flex gap-2 mb-4">
              <Badge className="bg-primary hover:bg-primary text-white border-none uppercase font-bold">
                Event
              </Badge>
              {event.fee === 0 ? (
                <Badge
                  variant="secondary"
                  className="text-secondary-foreground font-bold uppercase"
                >
                  Free
                </Badge>
              ) : (
        ...
        <div className="p-8 grid md:grid-cols-3 gap-8">
          <div className="md:col-span-2 space-y-6">
            <div>
              <h3 className="text-lg font-bold font-display mb-2 text-primary uppercase">
                About this Event
              </h3>
            ...
            {hasCompleted ? (
              <div className="bg-green-50 border border-green-200 rounded-xl p-4 text-center">
                ...
                <Link href={`/registrations/${existingRegistration?.id}`}>
                  <Button
                    variant="outline"
                    className="text-green-700 mt-2 uppercase font-bold text-xs"
                  >
                    View Status
                  </Button>
                </Link>
              ...
              <div className="bg-red-50 border border-red-200 rounded-xl p-4 text-center">
                ...
                <p className="text-red-800 font-bold uppercase text-xs">
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription className="uppercase font-bold text-red-600">
                    This action cannot be undone. Please enter admin password to
                    confirm.
                  </DialogDescription>
                </DialogHeader>
                <div className="py-4">
              ...
              <div className="space-y-4 animate-in slide-in-from-right-8 duration-300">
                    ...
                    onComplete={(result) => {
                      if (result.failed?.length) {
                        toast({
                          title: "Upload Failed",
                          description:
                            result.failed[0].error?.message || "Unknown error",
                          variant: "destructive",
                        });
                        return;
                      }
                ...
                {parentConsentUrl && (
                  <div className="bg-green-50 p-2.5 rounded-lg border border-green-100 flex items-center gap-2 justify-center">
                    ...
                    <span className="text-[11px] text-green-700 font-bold uppercase">
                      Form successfully attached
                    </span>
                  </div>
                )}
              </div>
                ...
                <div className="bg-muted/30 rounded-2xl border border-border/50 overflow-hidden">
                  ...
                  <div className="p-4 space-y-3">
                    ...
                    <div className="flex justify-between items-center text-xs">
                      ...
                      <Badge
                        variant="outline"
                        className="text-[9px] bg-green-50 text-green-700 border-green-100 uppercase"
                      >
                        Attached
                      </Badge>
                    </div>
